...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        lowervalues_shift = lowervalues[shift:] + lowervalues[:shift]
        
        upperkeys = list(string.ascii_uppercase)
        uppervalues = list(string.ascii_uppercase)
        uppervalues_shift = uppervalues[shift:] + uppervalues[:shift]
        
        togetherkeys = lowerkeys + upperkeys
        togethervalues = lowervalues_shift + uppervalues_shift
        
        self.shiftdict = dict(zip(togetherkeys, togethervalues))
...
class PlaintextMessage(Message):
    ...
    def get_encrypting_dict(self):
        ...
        return self.encrypting_dict_copy # or just call it 'encrypting_dict_copy'
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        return (best_shift_value, decrypted) # see what they do
        
# string.split useful for dividing the text up into words.
# 'Hello world!'.split('o') -> ['Hell', ' w', 'rld!']
# '6.00.1x is pretty fun'.split(' ') -> ['6.00.1x', 'is', 'pretty', 'fun']
