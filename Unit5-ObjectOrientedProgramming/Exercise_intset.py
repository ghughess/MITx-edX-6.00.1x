# -*- coding: utf-8 -*-
"""
Created on Wed Aug 11 11:42:40 2021
...
# would return a new intSet of integers that appear in both s1 and s2. Think carefully - what 
# should happen if s1 and s2 have no elements in common?
...
class intSet(object):
    ...
    def intersect(self, other):
        ...
        for i in self.vals:
            if i in other.vals:
                self.inter.append(i)
        return '{' + ','.join([str(i) for i in self.inter]) + '}'
    
    def __len__(self):
        """Loops through the list, counting the number of items, and 
