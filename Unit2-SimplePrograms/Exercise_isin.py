# -*- coding: utf-8 -*-
"""
Created on Wed Aug 11 10:05:17 2021
...
# We can use the idea of bisection search to determine if a character is in a string, so long as 
# the string is sorted in alphabetical order.
...
# char will be a single character and aStr will be a string that is in alphabetical order. The function 
